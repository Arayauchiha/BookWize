...
//    @State private var showHistory = false // To show the history sheet
//
//    // Filter pending requests for the main list
//    var pendingRequests: [BookRequest] {
//        bookRequests.filter { $0.Request_status == .pending }
//    }
//
//    // Filter approved and rejected requests for the history
...
//            }
//        }
//        .navigationTitle("Summary") // Match the title set in AdminDashboardView
//        .toolbar {
...
//}
//
//// New view for displaying the history of approved/rejected requests
