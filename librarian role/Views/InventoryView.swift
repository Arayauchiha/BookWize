...
//    @State private var requests: [BookRequest] = [] // Added to store request history
//    @State private var isFetchingRequests = false // Loading state for requests
//    
...
//            }
//            .sheet(isPresented: $showingRequestBook) {
//                RequestBookView() // Unchanged, shows the form
//            }
//            .sheet(item: $selectedBook) { book in
//                BookDetailView(book: book, inventoryManager: inventoryManager)
//            }
